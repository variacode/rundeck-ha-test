...
docker-compose exec --user rundeck rundeck2 ./rrsystem rundeck-system:set-execution-mode --execution-mode active --url http://rundeck2:4440/rundeckpro-dr --username admin --password admin
sleep 3;
